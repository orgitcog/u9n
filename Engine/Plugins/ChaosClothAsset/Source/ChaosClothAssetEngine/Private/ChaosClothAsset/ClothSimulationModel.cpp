...
CHAOSCLOTHASSETENGINE_API void FChaosClothSimulationModel::RemapBoneIndices(const TArray<int32>& BoneMap)
{
	...
	ReferenceBoneIndex = BoneMap.IsValidIndex(ReferenceBoneIndex) ? BoneMap[ReferenceBoneIndex] : RootBoneIndex;
	...
	{
		UsedBoneIndex = BoneMap.IsValidIndex(UsedBoneIndex) ? BoneMap[UsedBoneIndex] : RootBoneIndex;
	}
}
