...
void UEchobeatsStreamEngine::InitializeStepConfigs()
{
    ...
    StepConfigs[0].Mode = EStreamCognitiveMode::Expressive;
    ...
    StepConfigs[1].Mode = EStreamCognitiveMode::Expressive;
    ...
    StepConfigs[2].Mode = EStreamCognitiveMode::Expressive;
    ...
    StepConfigs[3].Mode = EStreamCognitiveMode::Expressive;
    ...
    StepConfigs[4].Mode = EStreamCognitiveMode::Expressive;
    ...
    StepConfigs[5].Mode = EStreamCognitiveMode::Reflective;
    ...
    StepConfigs[6].Mode = EStreamCognitiveMode::Reflective;
    ...
    StepConfigs[7].Mode = EStreamCognitiveMode::Expressive;
    ...
    StepConfigs[8].Mode = EStreamCognitiveMode::Expressive;
    ...
    StepConfigs[9].Mode = EStreamCognitiveMode::Reflective;
    ...
    StepConfigs[10].Mode = EStreamCognitiveMode::Reflective;
    ...
    StepConfigs[11].Mode = EStreamCognitiveMode::Reflective;
...
void UEchobeatsStreamEngine::InitializeTensionalCouplings()
{
    ...
    PerceptionMemory.ModeA = EStreamCognitiveMode::Expressive;
    PerceptionMemory.TermB = ESystem4Term::T7_MemoryEncoding;
    PerceptionMemory.ModeB = EStreamCognitiveMode::Reflective;
    ...
    AssessmentPlanning.ModeA = EStreamCognitiveMode::Reflective;
    AssessmentPlanning.TermB = ESystem4Term::T2_IdeaFormation;
    AssessmentPlanning.ModeB = EStreamCognitiveMode::Expressive;
    ...
    ActionIntegration.ModeA = EStreamCognitiveMode::Expressive;
    ActionIntegration.TermB = ESystem4Term::T8_BalancedResponse;
    ActionIntegration.ModeB = EStreamCognitiveMode::Expressive;
...
void UEchobeatsStreamEngine::DetectActiveCouplings()
{
    ...
    EStreamCognitiveMode CurrentMode = State.CurrentConfig.Mode;
