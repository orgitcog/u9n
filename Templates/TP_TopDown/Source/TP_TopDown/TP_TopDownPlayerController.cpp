...
void ATP_TopDownPlayerController::SetupInputComponent()
{
	...
	if (IsLocalPlayerController())
	{
		...
		{
			UE_LOG(LogTP_TopDown, Error, TEXT("'%s' Failed to find an Enhanced Input Component! This template is built to use the Enhanced Input system. If you intend to use the legacy system, then you will need to update this C++ file."), *GetNameSafe(this));
		}
	}
}
