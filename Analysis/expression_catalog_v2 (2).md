...
| Category | Expression ID | Description | Key Features | Intensity | Reference(s) |
|---|---|---|---|---|---|
| **Joy** | JOY_01 | Broad, genuine smile | Wide open mouth, visible teeth, strong eye crinkle (crow's feet) | High | `ac0509a8` |
| **Joy** | JOY_02 | Exuberant Laugh | Head tilted back, eyes fully squinted, mouth wide open | Peak | `7223e61f` |
| **Joy** | JOY_03 | Gentle, knowing smile | Closed-lip or slightly parted, soft eye crinkle, relaxed features | Low | `f49cceaa` |
| **Joy** | JOY_05 | Blissful Serenity | Eyes closed, serene closed-mouth smile, tranquil posture | Medium | `f80c13ce` |
| **Joy** | JOY_06 | Playful / Confident Grin | Asymmetric smile, often with one eyebrow slightly raised | Medium | `3db2fa59` |
| **Wonder** | WONDER_01 | Awe / Amazement | Slightly parted lips, wide eyes, raised brows, upward gaze | High | `ac0509a8` |
| **Wonder** | WONDER_02 | Focused Curiosity | Head tilted, eyes tracking an object of interest, slight lip part | Medium | `f80c13ce` |
| **Wonder** | WONDER_03 | Contemplation | Soft, distant gaze, relaxed mouth, introspective look | Low | `ac0509a8` |
| **Speaking** | SPEAK_01 | Open Vowel Shape | Wide mouth opening, relaxed jaw (e.g., "ah") | Medium | `17824d50` |
| **Speaking** | SPEAK_02 | Pursed Consonant | Lips pursed or pressed together (e.g., "oo", "m") | Low | `ac0509a8` |
| **Speaking** | SPEAK_03 | Emphatic Exclamation | Wide open mouth, raised brows, sharp movement | High | `7223e61f` |
| **Attention** | FOCUS_01 | Alert, Direct Gaze | Direct eye contact, neutral mouth, minimal movement | Medium | `17824d50` |
| **Attention** | FOCUS_02 | Upward Gaze | Eyes looking up, head tilted back, often paired with Wonder | Medium | `7223e61f` |
...
## Part 2: Unreal Engine Implementation Guide
